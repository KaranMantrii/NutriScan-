...
export default function Fitness() {
    const plans = [
        ...
        },
        {
            ...
            description: "Progressive overload program designed to build size and strength.",
            icon: Dumbbell,
        ...
        },
        {
            ...
            description: "Zone 2 cardio and aerobic training to strengthen your heart.",
            icon: Heart,
            iconBg: "bg-green-700",
        ...
        },
        {
            ...
            description: "Build healthy habits and a solid base for any fitness goal.",
            icon: Zap,
            iconBg: "bg-lime-600",
                ...
                <div className="grid grid-cols-3 gap-2 mt-5">
                    {[
                        ...
                        >
                            ...
                            <p className="text-[9px] font-black tracking-widest text-zinc-500 uppercase">{stat.label}</p>
                    ...
                    {plan.schedule.map((item) => (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <span className="text-[12px] font-black text-green-400 w-8">{item.day}</span>
