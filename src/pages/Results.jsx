  ...
  return (
    <div className="min-h-dvh text-white overflow-x-hidden pb-20">
      <header className="sticky top-0 z-50 p-1 flex items-center border-b border-white/10">
        ...
        <h4 className="text-lg font-medium text-zinc-300 font-chillax ml-2 flex-1">
          Back
        </h4>
      ...
      <main className="p-5 space-y-6">
        ...
        <div>
          <h2 className="text-sm font-medium text-zinc-400 mb-3 px-1 uppercase tracking-wider">
