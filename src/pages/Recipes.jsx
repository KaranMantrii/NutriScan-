        ...
        <div className="min-h-screen py-6 px-4 flex justify-center items-start">
            <div className="w-max max-w-2xl rounded-2xl shadow-2xl p-6 md:p-8 border">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-400 mt-2 font-chillax">The healthiest meal possible, using strictly what you have.</p>
                </div>
                
                {/* 1. Input Section */}
                <form onSubmit={handleAddIngredient} className="flex gap-3 mb-6 font-chillax">
                    <input 
                        type="text" 
                ...
                <div className="flex flex-wrap gap-2 mb-8 font-chillax min-h-10">
                    {ingredients.length === 0 && (
                        <span className="text-neutral-500 italic text-sm py-2">No ingredients added yet...</span>
                    )}
